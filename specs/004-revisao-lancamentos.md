...
| Decisão | Escolha |
|---|---|
| Editar | Toque no cartão do lançamento → mesmo diálogo do FAB, pré-preenchido. Editáveis: tipo, valor, descrição, categoria. Preservados: id, dataHora, origem, status, textoOrigem, notaFiscalId |
